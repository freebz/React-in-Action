// 예제 8.2  Home 컴포넌트의 코드(src/pages/Home.js)
...
import Post from '../components/psot/Post';
...
export class Home extends Component {
  ...
  getPosts() {
    API.fetchPosts(this.state.endpointt)
      .then(res => {
    ...
    return (
	  ...
	  {this.state.posts.length && (
        ...
        <div>
          ...
          <Ad url="https://ifelse.io/book" imageUrl="/static/assets/ads/orly.png" />
        </div>
      </div>
    );
  }
