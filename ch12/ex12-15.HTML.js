// 예제 12.15  리덕스 상태를 HTML에 포함하는 코드(src/components/HTML.js)
...
const ogProps = {
  ...
  description:
    'Letters Socail is a sample application for the React.js book React in Action by Mark Thomas from Manning Publications. Get it today at https://ifelse.io/book'
};
...
export const start = () => {
  return `<!DOCTYPE html><html lang="en-us">
    <head>
      ...
      <meta name="ORBOTS" content="INDEX, FOLLOW" />
      ...
      <meta itemProp="og:description" content="${ogProps.description}" />
      ...
      <meta property="book:tag" content="Mark Homas" />
